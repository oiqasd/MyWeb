        ...
        private class TypeDeserializerCache
        {
            ...
            struct DeserializerKey : IEquatable<DeserializerKey>
            {
                ...
                public bool Equals(DeserializerKey other)
                {
                    ...
                    for (int i = 0; i < length; i++)
                    {
                        if ((this.names != null ? this.names[i] : this.reader == null ? null : this.reader.GetName(startBound + i)) != (other.names != null ? other.names[i] : other.reader == null ? null : other.reader.GetName(startBound + i))
                            ||
                            (this.types != null ? this.types[i] : this.reader == null ? null : this.reader.GetFieldType(startBound + i)) != (other.types != null ? other.types[i] : other.reader == null ? null : other.reader.GetFieldType(startBound + i))
                            )
                        {
