...
namespace Dapper
{
    ...
    sealed class SqlDataRecordListTVPParameter : SqlMapper.ICustomQueryParameter
    {
        ...
        {
            var prop = typeof(System.Data.SqlClient.SqlParameter).GetProperty("TypeName", BindingFlags.Instance | BindingFlags.Public);//nameof(System.Data.SqlClient.SqlParameter.TypeName)
