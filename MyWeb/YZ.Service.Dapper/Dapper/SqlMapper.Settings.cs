...
namespace Dapper
{
    partial class SqlMapper
    {
        ...
        public static class Settings
        {
            ...
            internal static CommandBehavior AllowedCommandBehaviors { get { return DefaultAllowedCommandBehaviors; } private set { } } //= DefaultAllowedCommandBehaviors;
            ...
            internal static bool DisableCommandBehaviorOptimizations(CommandBehavior behavior, Exception ex)
            {
                    ...
                    && (behavior & (CommandBehavior.SingleResult | CommandBehavior.SingleRow)) != 0)
                {
                    ...
                    if (ex.Message.Contains("SingleResult") || ex.Message.Contains("SingleRow"))
            ...
            /// </summary>
            public static int InListStringSplitCount { get { return -1; } set{} }// = -1;
        }
    }
}
