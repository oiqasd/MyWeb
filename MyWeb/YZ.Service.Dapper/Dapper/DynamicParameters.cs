...
#pragma warning restore 0618
        ...
        public DynamicParameters Output<T>(T target, Expression<Func<T, object>> expression, DbType? dbType = null, int? size = null)
        {
            ...
            do
            {
                ...
                names.Insert(0, diving == null ? null : diving.Member.Name);
                chain.Insert(0, diving);

                var constant = diving == null ? null : diving.Expression as ParameterExpression;
                diving = diving == null ? null : diving.Expression as MemberExpression;
        ...
        MAKECALLBACK:
            (outputCallbacks ?? (outputCallbacks = new List<Action>())).Add(() =>
            {
                ...
                ParamInfo parameter;
                var targetMemberType = lastMemberAccess == null ? null : lastMemberAccess.Type;
...
#pragma warning disable 618
 ? SqlMapper.LookupDbType(targetMemberType, targetMemberType == null ? null : targetMemberType.Name, true, out handler)
