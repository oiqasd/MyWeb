<%@ Page Title="吃货福利" Language="C#" MasterPageFile="~/MsPage.Master" AutoEventWireup="true" CodeBehind="chihuo.aspx.cs" Inherits="YZ.Web.Asp.chihuo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="body" style="background-color: #f4f6f8;width:100%; background:url(../images/2015052211012624.jpg) no-repeat; background-size:cover">
    ...
    <script>
        ...
        function load() {
            ...
            if (stop == true && $('#h-more').val() == undefined) {
                ...
                stop = false;
                $.post("chihuo.aspx?index=" + index + "&IsLoad=true", function (data) {
                    //$('#h-more').empty();
                    if (data != undefined) {
                        ...
                        //添加样式
                        $('#da-thumbs > a').hoverdir();
                    } else { console.log('chihuo.aspx data is undefined!'); }
                    stop = true;
                });
            } else { }
        }
